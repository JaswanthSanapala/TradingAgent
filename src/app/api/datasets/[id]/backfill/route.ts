...
import { BackfillJobData,defaultJobOpts, queues } from '@/lib/trading/queue';

export const dynamic = 'force-dynamic';

// POST /api/datasets/:id/backfill
...
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const jobData: BackfillJobData = { datasetId: id, from, to };
    const job = await queues.data_backfill.add('dataset_backfill', jobData, defaultJobOpts);
